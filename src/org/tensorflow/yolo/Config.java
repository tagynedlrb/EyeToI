...
public interface Config {
    ...
    String MODEL_FILE = "my-tiny-yolo4.pb";   // The filepath of the model GraphDef protocol buffer.
    String LABEL_FILE = "labels.txt"; // The filepath of label file for classes.
